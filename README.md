...
- Pure Java, `SurfaceView`, `Canvas`, and manual APK packaging.
- No Gradle, no mandatory Android Studio workflow, no AndroidX, and no game engine.
- Real build artifacts are already included in the repository.
- Release APKs stay in the ~16.8 KB range instead of the usual multi-megabyte footprint.

- Чистый Java, `SurfaceView`, `Canvas` и ручная упаковка APK.
- Без Gradle, без обязательного сценария через Android Studio, без AndroidX и без игровых движков.
- Готовые артефакты сборки уже лежат в репозитории.
- Release APK остаются примерно на уровне 16.8 KB вместо привычных мегабайт.
...
| [Sandbox][sandbox-readme] | Falling-sand sandbox with powders, water, seeds, heat, steam, simple farming, and cooking reactions.<br>Песочница с порошками, водой, семенами, жаром, паром, простым выращиванием и кулинарными реакциями. | `Sandbox.apk` - 20,907 bytes<br>`Sandbox-release.apk` - 16,811 bytes |
| [Build Guides][build-guides] | Manual build notes for `aapt2 -> ecj -> d8/R8 -> zipalign -> apksigner`, plus R8 shrinking guidance.<br>Гайды по ручной сборке через `aapt2 -> ecj -> d8/R8 -> zipalign -> apksigner` и отдельные заметки по R8. | Documentation / Документация |
  ...
  <tr>
    <td align="center">
      <a href="./Sandbox%20-%2016-20%D0%BA%D0%B1%20%D0%B2%D0%B5%D1%81/README.md">
        <img src="./docs/images/sandbox-screenshot.jpg" alt="Sandbox screenshot" width="260">
      </a>
    </td>
    <td align="center">
      <a href="./Tetris%20-%2016%D0%BA%D0%B1%20%D0%B2%D0%B5%D1%81/README.md">
        <img src="./docs/images/tetris-screenshot.jpg" alt="Tetris screenshot" width="260">
      </a>
    </td>
  </tr>
  <tr>
    <td align="center"><strong>Sandbox</strong><br>Particles, heat, farming, and cooking.</td>
...
- `aapt2`, `ecj`, `d8`, `R8`, `zipalign`, `apksigner`
- No Gradle, Kotlin, AndroidX, or external UI/game frameworks

- Java 8
- Platform API из Android SDK
- `SurfaceView` и `Canvas`
- `aapt2`, `ecj`, `d8`, `R8`, `zipalign`, `apksigner`
- Без Gradle, Kotlin, AndroidX и внешних UI- и игровых фреймворков
...
- [Sandbox project][sandbox-readme]
- [Manual build notes][build-guides]
- [R8 / ProGuard guide][r8-guide]
- [Third-party tools notice][third-party-tools]
- [MIT license][license-en]
- [Russian license translation][license-ru]
